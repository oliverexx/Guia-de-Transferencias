...
# =============================================================================
# Script: Tr4nsfieroArchivos.sh
# Descripción: Herramienta para transferir archivos entre sistemas
# Autor: Oliver
# Fecha: 2024
# =============================================================================
...
get_target_ip() {
    while true; do
        ...
        show_error "IP inválida. Por favor, ingrese una IP válida."
        show_info "Ejemplos válidos:"
        echo "- 192.168.1.100"
        echo "- 10.0.0.1"
        echo "- 172.16.0.1"
    done
...
get_target_domain() {
    while true; do
        ...
        show_error "Dominio inválido. Por favor, ingrese un dominio válido."
        show_info "Ejemplos válidos:"
        echo "- ejemplo.com"
...
get_credentials() {
    while true; do
        ...
        show_error "Nombre de usuario inválido. Por favor, use solo letras, números, guiones y puntos."
    done
...
get_files() {
    while true; do
        ...
        show_error "Archivo no encontrado. Por favor, ingrese una ruta válida."
        show_info "Ejemplos válidos:"
    ...
    while true; do
        ...
        show_error "Ruta inválida. Por favor, ingrese una ruta válida."
        show_info "Ejemplos válidos:"
...
get_port() {
    while true; do
        ...
        show_error "Puerto inválido. Por favor, ingrese un puerto válido."
        show_info "Ejemplos válidos:"
        echo "- 80 (HTTP)"
        echo "- 443 (HTTPS)"
        echo "- 445 (SMB)"
...
# =============================================================================
# Funciones de implementación de transferencia
# =============================================================================
